...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#manualManualInterestList" class="btn btn-primary" data-toggle="modal"><i class="fas fa-question-circle"></i> <span><?php echo $lang['help']?></span></a>
    </div>
...
<!-- Manual Modal HTML -->
<div id="manualManualInterestList" class="modal fade">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">              
                   <?php
                   if(isset($_SESSION['lang'])){
                       if($_SESSION['lang'] == "gr"){
                           include_once 'manuals/manualManualInterestedGreek.html';
                       }else if ($_SESSION['lang'] == "en"){
                           include_once 'manuals/manualManualInterestedEnglish.html';
                       }
                   }                   
                   ?>
                    <div class="modal-footer">
