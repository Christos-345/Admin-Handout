...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#manualRenovation" class="btn btn-primary" data-toggle="modal"><i class="fas fa-question-circle"></i> <span><?php echo $lang['help']?></span></a>
    </div>
...
<!-- Manual Modal HTML -->
<div id="manualRenovation" class="modal fade">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">              
                   <?php
                   if(isset($_SESSION['lang'])){
                       if($_SESSION['lang'] == "gr"){
                           include_once 'manuals/manualRenovationsGreek.html';
                       }else if ($_SESSION['lang'] == "en"){
                           include_once 'manuals/manualRenovationsEnglish.html';
                       }
                   }                   
                   ?>
                    <div class="modal-footer">
